...
from core.agent.utils.training_target_builder import LegacyTargetBuilder
from core.environment.trade_state import MarketState, AgentState, TradeState
from lib.utils.fileio import load_json


class LegacyTargetBuilderTest(unittest.TestCase):
	...
	def setUp(self):
		...
		self.builder = LegacyTargetBuilder(
			bounds=self.bounds
		)
