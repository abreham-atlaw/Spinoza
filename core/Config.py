...
OANDA_SIM_DELTA_MULTIPLIER = 1 if IS_LIVE else 3
OANDA_SIM_MARGIN_RATE = 0.01
OANDA_SIM_BALANCE = 100
OANDA_SIM_ALIAS = "Sim Account 0"
OANDA_SIM_TIMES_PATH = os.path.join(RES_DIR, "times/times-9hr-it-5.json")
...
AGENT_TRADE_STOP_LOSS_VALUE_BOUND = (0.0010, 0.002)
