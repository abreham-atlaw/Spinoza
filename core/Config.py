...
AGENT_STOP_LOSS_GRANULARITY = 0.005
AGENT_TRADE_STOP_LOSS_VALUE_BOUND = (0.001, 0.0015)
AGENT_STOP_LOSS_ABSOLUTE_VALUE_MULTIPLIER = 1.0
AGENT_USE_TAKE_PROFIT = True
AGENT_TAKE_PROFIT_GRANULARITY = 0.0005
AGENT_TRADE_TAKE_PROFIT_VALUE_BOUND = (0.0001, 0.002)
AGENT_TAKE_PROFIT_ABSOLUTE_VALUE_MULTIPLIER = 1.0
AGENT_TRIGGER_PRICE_GRANULARITY = MARKET_STATE_GRANULARITY
...
AGENT_FOCUSED_INSTRUMENT_SIMULATION = True
...
AGENT_PREDICTION_REFLEX_EVALUATOR_LOG_RETURNS = True
AGENT_DRMCA_WP = 100
...
AGENT_MODEL_AGGREGATION_ALPHA = [0.99/5]*3 + [0.99]
...
CORE_MODEL_CONFIG = ModelConfig(
	...
	path=os.path.join(BASE_DIR, "temp/models/abrehamalemu-spinoza-training-cnn-0-it-97-tot.zip"),
	download=False
)
