...
UPDATE_SAVE_PATH = os.path.join(EXPORT_DIR, "Data/drmca_export/00")
UPDATE_TRAIN = False
...
AGENT_TRADE_STOP_LOSS_VALUE_BOUND = (0.0001, 0.005)
...
CORE_MODEL_CONFIG = ModelConfig(
	...
	path=os.path.join(BASE_DIR, "temp/models/abrehamalemu-spinoza-training-cnn-2-it-98-tot.zip"),
	download=False
)
