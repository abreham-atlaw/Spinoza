...
UPDATE_EXPORT_BATCH_SIZE = 2
OUT_PATH = "/tmp/out/"
UPDATE_SAVE_PATH = os.path.join(OUT_PATH, "outs")
DUMP_CANDLESTICKS_PATH = os.path.join(OUT_PATH, "candlesticks")
AGENT_DUMP_NODES_PATH = os.path.join(OUT_PATH, "graph_dumps")
AGENT_DUMP_NODES = True
UPDATE_TRAIN = False
AGENT_CRA_SIZE = 0
