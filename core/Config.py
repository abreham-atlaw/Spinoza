...
OANDA_SIM_DELTA_MULTIPLIER = 1 if IS_LIVE else 5
OANDA_SIM_MARGIN_RATE = 0.01
OANDA_SIM_BALANCE = 100
OANDA_SIM_ALIAS = "Sim Account 0"
OANDA_SIM_TIMES_PATH = os.path.join(RES_DIR, "times/times-1day-it-1.json")
...
TIME_PENALTY = 0
AGENT_EPISODE_TAKE_PROFIT = 1.01
AGENT_EPISODE_STOP_LOSS = 0.8
AGENT_EPISODE_ATTACH_TAKE_PROFIT = True
