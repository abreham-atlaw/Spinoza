...
UPDATE_SAVE_PATH = os.path.join(EXPORT_DIR, "Data/drmca_export/01")
UPDATE_TRAIN = False
...
AGENT_STOP_LOSS_GRANULARITY = 0.0003
AGENT_TRADE_STOP_LOSS_VALUE_BOUND = (0.0003, 0.005)
AGENT_STOP_LOSS_ABSOLUTE_VALUE_MULTIPLIER = 1.0
AGENT_USE_TAKE_PROFIT = True
AGENT_TAKE_PROFIT_GRANULARITY = 0.0003
AGENT_TRADE_TAKE_PROFIT_VALUE_BOUND = (0.001, 0.0008)
...
AGENT_MODEL_AGGREGATION_ALPHA = 0.99/1
