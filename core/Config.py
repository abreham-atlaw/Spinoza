...
AGENT_MODEL_AGGREGATION_ALPHA = 99/2
...
CORE_MODEL_CONFIG = ModelConfig(
	...
	path=os.path.join(BASE_DIR, "/home/abrehamatlaw/Downloads/Compressed/abrehamalemu-spinoza-training-cnn-1-it-89-tot.0.zip"),
	download=False
)
